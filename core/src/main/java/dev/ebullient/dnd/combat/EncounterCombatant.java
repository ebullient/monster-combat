...
class EncounterCombatant implements Combatant {
    ...
    public EncounterCombatant(Beast b, Dice.Method method) {
        this.beast = b;
        this.method = method;
    ...
    EncounterCombatant(Beast b, int initiative, int startingHitPoints) {
        this.beast = b;
    ...
    EncounterCondition addCondition() {
        this.condition = new EncounterCondition();
        return condition;
    }
